<a href="{{ $url_images }}" class="image" title="Gambar: {{ $model->name }}"><i class="fa fa-file-image-o text-dark"></i></a> |
<a href="{{ $url_show }}" class="btn-show" title="Detail: {{ $model->name }}"><i class="fa fa-eye text-secondary"></i></a> |
